...
declare namespace spoonShaka {
    ...
    implements shaka.util.IDestroyable
  {
    ...
    constructor(
      ...
      dependencyInjector?: (a: shaka.Player | null) => any
    );
    /**
    ...
    detachAndSavePreload(
      ...
      saveLivePosition?: boolean
    ): Promise<shaka.media.PreloadManager | null>;
    /**
     ...
     */
    load(
      assetUriOrPreloader: string | shaka.media.PreloadManager | null,
...
declare namespace shaka.abr {
  class SimpleAbrManager
    implements shaka.extern.AbrManager, shaka.util.IReleasable
  {
...
declare namespace shaka.ads {
  ...
  class AdManager
    extends shaka.util.FakeEventTarget
    implements shaka.extern.IAdManager, shaka.util.IReleasable
  {
...
declare namespace shaka.cast {
    ...
    implements shaka.util.IDestroyable
  {
    ...
    constructor(
      video: HTMLMediaElement,
      player: shaka.Player,
      appDataCallback?: (a: object | null) => any,
      contentIdCallback?: (a: string) => string
    );
    /**
...
declare namespace shaka.cea {
  ...
  class Mp4CeaParser implements shaka.extern.ICeaParser {
    ...
    parse(
      mediaSegment: ArrayBuffer | ArrayBufferView
...
declare namespace shaka.lcevc {
  class Dec implements shaka.util.IReleasable {
    ...
    constructor(
      ...
      lcevcConfig: shaka.extern.LcevcConfiguration
    );
    /**
     * Close LCEVC Decoder.
     */
...
declare namespace shaka.media {
  ...
  class InitSegmentReference {
    ...
    constructor(
      ...
      startByte: number,
      endByte: number | null,
      mediaQuality?: null | shaka.extern.MediaQualityInfo,
      timescale?: null | number,
      segmentData?: null | ArrayBuffer | ArrayBufferView,
      aesKey?: shaka.extern.aesKey | null
    );
    /**
...
declare namespace shaka.media {
    ...
    implements Iterable<shaka.media.SegmentReference>
  {
    ...
    updateEvery(
      interval: number,
      updateCallback: () => (shaka.media.SegmentReference | null)[] | null
    ): any;
  }
}
// Generated from /home/runner/work/shaka-player/shaka-player/dist/shaka-player.compiled.externs.js
...
declare namespace shaka.media {
  ...
  class PresentationTimeline {
     ...
     */
    notifyTimeRange(
      timeline: shaka.media.PresentationTimeline.TimeRange[],
      startOffset: number
    ): any;
    /**
...
declare namespace shaka.media {
  ...
  class SegmentIndex
    implements
      ...
      Iterable<shaka.media.SegmentReference>
  {
    ...
    getIteratorForTime(
      time: number,
      allowNonIndepedent?: boolean,
      reverse?: boolean
    ): shaka.media.SegmentIterator | null;
    getNumEvicted(): any;
...
declare namespace shaka.media {
  ...
  class SegmentIterator
    implements Iterator<shaka.media.SegmentReference | null>
  {
     ...
     */
    constructor(
      segmentIndex: shaka.media.SegmentIndex | null,
      index: number,
...
declare namespace shaka.media.SegmentPrefetch {
  type FetchDispatcher = (
    a: shaka.media.InitSegmentReference | shaka.media.SegmentReference,
    b: shaka.extern.Stream,
    c?: ((a: ArrayBuffer | ArrayBufferView) => Promise<any>) | null
...
declare namespace shaka.media {
  ...
  class SegmentReference {
    ...
    constructor(
      ...
      partialReferences?: shaka.media.SegmentReference[],
      tilesLayout?: string | null,
      tileDuration?: number | null,
      syncTime?: number | null,
      status?: shaka.media.SegmentReference.Status,
      aesKey?: shaka.extern.aesKey | null,
     ...
     */
    setThumbnailSprite(
      thumbnailSprite: shaka.media.SegmentReference.ThumbnailSprite
    ): any;
    /**
...
declare namespace shaka.net {
    ...
    implements shaka.util.IDestroyable
  {
     ...
     */
    constructor(
      onProgressUpdated?: shaka.net.NetworkingEngine.onProgressUpdated,
      onHeadersReceived?: shaka.net.NetworkingEngine.OnHeadersReceived,
      onDownloadFailed?: shaka.net.NetworkingEngine.OnDownloadFailed,
      onRequest?: shaka.net.NetworkingEngine.OnRequest,
      onRetry?: shaka.net.NetworkingEngine.OnRetry,
      onResponse?: shaka.net.NetworkingEngine.OnResponse
    );
    /**
    ...
    static makeRequest(
      ...
      streamDataCallback?:
        | ((a: ArrayBuffer | ArrayBufferView) => Promise<any>)
        | null
...
declare namespace shaka.net.NetworkingEngine {
  type OnDownloadFailed = (
    a: shaka.extern.Request,
    b: shaka.util.Error | null,
    c: number,
    d: boolean
  ) => any;
}
...
declare namespace shaka.net.NetworkingEngine {
  type OnHeadersReceived = (
    a: { [key: string]: string },
    b: shaka.extern.Request,
    c: shaka.net.NetworkingEngine.RequestType
  ) => any;
}
// Generated from /home/runner/work/shaka-player/shaka-player/dist/shaka-player.compiled.externs.js
declare namespace shaka.net.NetworkingEngine {
  type OnRequest = (
    a: shaka.net.NetworkingEngine.RequestType,
    b: shaka.extern.Request,
    c: shaka.extern.RequestContext | undefined
  ) => any;
}
// Generated from /home/runner/work/shaka-player/shaka-player/dist/shaka-player.compiled.externs.js
declare namespace shaka.net.NetworkingEngine {
...
declare namespace shaka.net.NetworkingEngine {
  type OnRetry = (
    a: shaka.net.NetworkingEngine.RequestType,
    b: shaka.extern.RequestContext | undefined,
    c: string,
    d: string
  ) => any;
}
...
declare namespace shaka.net.NetworkingEngine {
  ...
  class PendingRequest
    ...
    implements shaka.extern.IAbortableOperation<any>
  {
    ...
    constructor(
      promise: Promise<any>,
      onAbort: shaka.extern.CreateSegmentIndexFunction,
      numBytesRemainingObj: shaka.net.NetworkingEngine.NumBytesRemainingClass | null
    );
  }
}
// Generated from /home/runner/work/shaka-player/shaka-player/dist/shaka-player.compiled.externs.js
...
declare namespace shaka.offline {
  ...
  class StorageMuxer implements shaka.util.IDestroyable {
    ...
    static register(
      name: string,
      factory: () => shaka.extern.StorageMechanism | null
    ): any;
    /**
...
declare namespace shaka.transmuxer {
  class TransmuxerEngine implements shaka.util.IDestroyable {
    ...
    static findTransmuxer(
      mimeType: string,
      contentType?: string
    ): shaka.extern.TransmuxerPlugin | null;
...
declare namespace shaka.util {
  class BufferUtils {
     ...
     */
    static equal(
      arr1: ArrayBuffer | ArrayBufferView | null,
      arr2: ArrayBuffer | ArrayBufferView | null
    ): boolean;
    /**
...
declare namespace shaka.util {
  class FairPlayUtils {
     ...
     */
    static expressplayFairPlayRequest(
      type: shaka.net.NetworkingEngine.RequestType,
      request: shaka.extern.Request,
      context?: shaka.extern.RequestContext
    ): any;
     ...
     */
    static expressplayInitDataTransform(
      initData: Uint8Array,
      initDataType: string,
      drmInfo: shaka.extern.DrmInfo | null
    ): any;
    ...
    static initDataTransform(
      ...
      contentId: ArrayBuffer | ArrayBufferView | string,
      cert: ArrayBuffer | ArrayBufferView | null
    ): Uint8Array;
    /**
...
declare namespace shaka.util {
  class FakeEventTarget implements EventTarget, shaka.util.IReleasable {
    ...
    removeEventListener(
      type: string,
      listener: EventListener | null | ((a: Event) => any),
      options?: EventListenerOptions | null | boolean
    ): any;
  }
}
// Generated from /home/runner/work/shaka-player/shaka-player/dist/shaka-player.compiled.externs.js
...
declare namespace shaka.util {
  class StreamUtils {
    ...
    static meetsRestrictions(
      ...
      maxHwRes: shaka.extern.Resolution
    ): boolean;
  }
}
// Generated from /home/runner/work/shaka-player/shaka-player/dist/shaka-player.compiled.externs.js
...
declare namespace shaka.util {
  class TsParser {
    ...
    parseAvcNalus(
      ...
      nextPes?: shaka.extern.MPEG_PES | null
    ...
    parseNalus(
      pes: shaka.extern.MPEG_PES,
      lastNalu?: shaka.extern.VideoNalu | null,
...
declare namespace shaka.extern {
  ...
  interface IAdManager extends EventTarget {
    ...
    onHLSInterstitialMetadata(
      basePlayer: shaka.Player,
      baseVideo: HTMLMediaElement,
      interstitial: shaka.extern.HLSInterstitial
    ): any;
    onHlsTimedMetadata(
...
declare namespace shaka.extern {
  type DrmInfo = {
    ...
    initData: shaka.extern.InitDataOverride[] | null;
    keyIds: Set<string> | null;
    keySystem: string;
...
declare namespace shaka.extern {
  type Manifest = {
    ...
    serviceDescription: shaka.extern.ServiceDescription | null;
    startTime: number | null;
...
declare namespace shaka.extern {
  type Stream = {
    accessibilityPurpose: shaka.media.ManifestParser.AccessibilityPurpose | null;
    audioSamplingRate: number | null;
    bandwidth?: number;
    channelsCount: number | null;
    closeSegmentIndex?: () => any;
    ...
    matchedStreams?: any[];
    mimeType: string;
    mssPrivateData?: shaka.extern.MssPrivateData;
...
declare namespace shaka.extern {
  type aesKey = {
    ...
    cryptoKey?: webCrypto.CryptoKey | null;
    fetchKey?: shaka.extern.CreateSegmentIndexFunction;
...
declare namespace shaka.extern.ManifestParser {
  type PlayerInterface = {
    addFont: (a: string, b: string) => any;
    disableStream: (a: shaka.extern.Stream) => any;
    enableLowLatencyMode: () => any;
    filter: (a: shaka.extern.Manifest) => Promise<any>;
    getBandwidthEstimate: () => number;
    isAutoLowLatencyMode: () => boolean;
    isLowLatencyMode: () => boolean;
    makeTextStreamsForClosedCaptions: (a: shaka.extern.Manifest) => any;
    networkingEngine: shaka.net.NetworkingEngine;
    newDrmInfo: (a: shaka.extern.Stream) => any;
    onError: (a: shaka.util.Error) => any;
    onEvent: shaka.util.EventManager.ListenerType;
    onManifestUpdated: () => any;
    onMetadata: (
      a: string,
      b: number,
      c: number | null,
      d: shaka.extern.MetadataFrame[]
    ) => any;
    onTimelineRegionAdded: (a: shaka.extern.TimelineRegionInfo) => any;
    updateDuration: () => any;
  };
}
...
declare namespace shaka.extern {
  type RequestContext = {
    isPreload?: boolean;
    segment?: shaka.media.SegmentReference | null;
...
declare namespace shaka.extern {
  type SchemePlugin = (
    ...
    b: shaka.extern.Request,
    c: shaka.net.NetworkingEngine.RequestType,
    d: shaka.extern.ProgressUpdated,
    e: shaka.extern.HeadersReceived,
    f: shaka.extern.SchemePluginConfig
...
declare namespace shaka.extern {
  type EmeSessionDB = {
    audioCapabilities: { contentType: string; robustness: string }[];
    keySystem: string;
    licenseUri: string;
    serverCertificate: Uint8Array | null;
    sessionId: string;
    videoCapabilities: { contentType: string; robustness: string }[];
  };
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/offline.js
declare namespace shaka.extern {
...
declare namespace shaka.extern {
  type DashManifestConfiguration = {
    ...
    manifestPreprocessor: (a: Element) => any;
    manifestPreprocessorTXml: (a: shaka.extern.xml.Node) => any;
...
declare namespace shaka.extern {
  type DrmConfiguration = {
    advanced: { [key: string]: shaka.extern.AdvancedDrmConfiguration } | null;
    clearKeys: { [key: string]: string };
    delayLicenseRequestUntilPlayed: boolean;
    ignoreDuplicateInitData: boolean;
    initDataTransform?: shaka.extern.InitDataTransform;
    ...
    persistentSessionsMetadata: shaka.extern.PersistentSessionMetadata[];
...
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
  type DynamicTargetLatencyConfiguration = {
    enabled: boolean;
    maxAttempts: number;
    maxLatency: number;
    minLatency: number;
...
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
  type HLSInterstitial = {
    endTime: number | null;
    startTime: number;
    values: shaka.extern.MetadataFrame[];
  };
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
...
declare namespace shaka.extern {
  type ID3Metadata = {
    ...
    data: Uint8Array;
    dts: number | null;
    frames: shaka.extern.MetadataFrame[];
    pts: number | null;
  };
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
  type InitDataTransform = (
    a: Uint8Array,
    b: string,
    c: shaka.extern.DrmInfo | null
  ) => Uint8Array;
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
...
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
  type MediaSourceConfiguration = {
    addExtraFeaturesToSourceBuffer: (a: string) => string;
...
declare namespace shaka.extern {
  type MetadataFrame = {
    data: ArrayBuffer | null | string | number;
    description: string;
    key: string;
    mimeType: string | null;
...
declare namespace shaka.extern {
  type MssManifestConfiguration = {
    keySystemsBySystemId: { [key: string]: string };
    manifestPreprocessor: (a: Element) => any;
    manifestPreprocessorTXml: (a: shaka.extern.xml.Node) => any;
    sequenceMode: boolean;
  };
...
declare namespace shaka.extern {
  type OfflineConfiguration = {
    downloadSizeCallback: (a: number) => Promise<boolean>;
    numberOfParallelDownloads: number;
    progressCallback: (a: shaka.extern.StoredContent, b: number) => any;
    trackSelectionCallback: (
      a: shaka.extern.TrackList
...
declare namespace shaka.extern {
  type PlaybackInfo = {
    audio: shaka.extern.PlaybackStreamInfo | null;
    text: shaka.extern.PlaybackStreamInfo | null;
    video: shaka.extern.PlaybackStreamInfo | null;
  };
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
...
declare namespace shaka.extern {
  type StreamingConfiguration = {
    ...
    evictionGoal: number;
    failureCallback: (a: shaka.util.Error) => any;
    forceHTTP: boolean;
    forceHTTPS: boolean;
...
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/player.js
declare namespace shaka.extern {
  type TimelineRegionInfo = {
    endTime: number;
    eventElement: Element | null;
    eventNode: shaka.extern.xml.Node | null;
    id: string;
    schemeIdUri: string;
    startTime: number;
    value: string;
...
declare namespace shaka.extern.TextParser {
   ...
   */
  type ModifyCueCallback = (
    a: shaka.text.Cue,
    b: string | null,
    c: shaka.extern.TextParser.TimeContext
  ) => any;
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/shaka/text.js
declare namespace shaka.extern.TextParser {
...
declare namespace shaka.extern {
  ...
  interface Transmuxer {
    ...
    transmux(
      data: ArrayBuffer | ArrayBufferView,
      stream: shaka.extern.Stream,
      reference: shaka.media.SegmentReference | null,
      duration: number,
      contentType: string
    ): Promise<Uint8Array>;
  }
